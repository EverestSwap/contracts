...
describe('StakingRewards', function () {
    ...
    beforeEach(async function () {
        ...
        this.stakingRewards = await this.StakingRewards.deploy(this.evrs.address, this.lpToken.address);
    ...
    describe("startVesting", function () {
        it('Start vesting successfully', async function () {
            ...
            await this.evrs.transfer(this.stakingRewards.address, vestAmount);
            ...
            expect(await this.evrs.balanceOf(this.addr2.address)).to.equal(actualAmount);
        ...
        it('Two stakers, same time', async function () {
            ...
            expect(await this.evrs.balanceOf(this.addr2.address)).to.equal(actualAmount);
            expect(await this.evrs.balanceOf(this.addr3.address)).to.equal(actualAmount);
        ...
        it('Two stakers, different times', async function () {
            ...
            await this.stake2.getReward();
            await this.stake3.getReward();
            expect(await this.evrs.balanceOf(this.addr2.address)).to.equal(largerAmount);
            expect(await this.evrs.balanceOf(this.addr3.address)).to.equal(smallerAmount);
        });
        ...
        it('Early withdraw, the whole second period', async function () {
            ...
            expect(await this.evrs.balanceOf(this.addr2.address)).to.equal(smallerAmount);
